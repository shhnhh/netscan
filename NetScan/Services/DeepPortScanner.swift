...
actor DeepPortScanner {
    static let scanPorts: [Int] = [
        ...
        1433, 2323, 3306, 3389, 5000, 5060, 5432, 5900, 6379, 7000,
        8000, 8080, 8081, 8443, 8554, 8888, 9100, 27017, 34567, 37777, 37778, 62078,
    ]

    private static let bannerPorts: Set<Int> = [
        21, 22, 23, 25, 80, 110, 143, 443, 554, 3306, 5432, 6379,
        8000, 8080, 8081, 8443, 8554, 8888, 27017, 34567, 37777,
    ]
